...
- Comparación de DT con diferentes `max_depths` y usando one_tree_per_output en False y True y con y sin resíntesis.
...
- Comparación de todos los métodos.
  ...
  umbral de error.
    - Voy a hacer estos con resíntesis y citar el paper de Roger y digo que probablemente siempre es mejor.
...
- [x] Generar sets de datos a utilizar en todos los experimentos.
  - [x] Adaptar AxLS para poder crear sets de datos exhaustivos.

## Herramienta

- [x] Hacer una función que valide la configuración.
- [x] Hacer un __main__ que acepte la configuración a través de CLI.
- [x] Hacer que la función de ejecución principal itere los benchmarks y guarde
      el progreso.
- [x] Hacer que la función de ejecución principal cronometre las ejecuciones
    - [x] Guarde tiempo en objeto (o dict) de resultados.
- [x] Agregar DTs como un método formal de la herramienta.
- [x] Crear funciones para la ejecución de cada método dentro de la herramienta.
  - [x] InOuts In
  - [x] InOuts Out
  - [x] ccarving
  - [x] glpsignificance
